...
def get_constr_out(x, R):
    """ Given the output of the neural network x returns the output of MCM 
        using the Product t-norm in the constraint layer """
    c_out = x.double()
    ...
    final_out = R_batch * c_out  # Changed Lukasiewicz t-norm to product t-norm
...
def main():
    ...
    parser.add_argument('--num_epochs', type=int, default=100, help='Max number of epochs to train (default:2000)')
